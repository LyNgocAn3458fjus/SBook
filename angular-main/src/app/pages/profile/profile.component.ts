...
export class ProfileComponent implements OnInit {
  ...
  action_In_ngOnInit() {
    ...
    if (sessionStorage.getItem('UserLogin') != null) {
      ...
      this.bookstoreapi.getProfile(this.data.id).subscribe({
  ...
  updateInfo() {
    ...
    check.push(!(this.hovaten == ""));
    check.push(!(this.Email == ""));
    check.push(!(this.diachi == ""));
    check.push(!(this.sdt == ""));
    check.push(!(this.date == ""));

    check.push(!(this.hovaten == null));
    check.push(!(this.Email == null));
    check.push(!(this.diachi == null));
    check.push(!(this.sdt == null));
    check.push(!(this.date == null));
    ...
    if (check.every(isTrue)) {
      ...
      if (this.data.id != null) {
        ...
        if (!(this.imgchoose == "")) {
          ...
          this.bookstoreapi.UploadImage(formdata).subscribe({
            ...
            next: res => {
              ...
              this.bookstoreapi.putupdateprofile(bodyProfile).subscribe({
                ...
                next: data => {
                  ...
                  this.toastr.success(this.resProfile.Messenger);
          ...
          let bodyProfilenoimg = new reqprofilenoimg(
            this.data.id,
            this.hovaten,
            this.Email,
            this.diachi,
  ...
  UpdataPass() {
    ...
    check.push(!(this.matkhauhientai == ""));
    check.push(!(this.matkhaumoi == ""));
    check.push(!(this.xacnhanmatkhau == ""));
      ...
      if (this.data.id != null) {
        ...
        this.bookstoreapi.putupdatapass(bodypass).subscribe({
          ...
          next: data => {
            ...
            this.toastr.success(this.resPass.Messenger);
