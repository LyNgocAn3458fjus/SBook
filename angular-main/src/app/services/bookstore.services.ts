...
export class BookStoreAPI {
    ...
    getAllVouchers() {
        return this.httclient.get(`${this.url}/vouchers`);
    }

    createVoucher(voucherData: any): Observable<any> {
        return this.httclient.post(`${this.url}/vouchers`, voucherData);
    }

    updateVoucher(voucherId: string, voucherData: any): Observable<any> {
        return this.httclient.put(`${this.url}/vouchers/${voucherId}`, voucherData);
    }

    deleteVoucher(voucherId: string): Observable<any> {
        return this.httclient.delete(`${this.url}/vouchers/${voucherId}`);
    }

    getVoucherByCode(code: string): Observable<any> {
        return this.httclient.get(`${this.url}/vouchers/${code}`);
    }

    applyVoucher(voucherData: any): Observable<any> {
        return this.httclient.post(`${this.url}/vouchers/apply`, voucherData);
      }
}
